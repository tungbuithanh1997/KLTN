...
import ducthuan.com.lamdep.Activity.ChiTietDonHangKhachHangActivity;
...
public class DonMuaAdapter extends RecyclerView.Adapter<DonMuaAdapter.ViewHolder>{
    ...
    public DonMuaAdapter(Context context, ArrayList<QuanLyDonHangShop> quanLyDonHangShops, ArrayList<String>madhs) {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, ChiTietDonHangKhachHangActivity.class);
