...
public class HinhSanPhamAdapter extends RecyclerView.Adapter<HinhSanPhamAdapter.ViewHolder>{

    Context context;
    ArrayList<Uri>dsHinhSP;

    public HinhSanPhamAdapter(Context context, ArrayList<Uri> dsHinhSP) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.dong_anhnho_themsanpham,parent,false);
